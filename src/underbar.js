(function() {
  ...
  _.map = function(collection, iterator) {
    ...
    var mapped = [];
    for (var i = 0; i < collection.length; i++) {
      mapped[i] = (iterator(collection[i], i, collection));
    }
    return mapped;
  };
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (pastFunctions[args]) {
        return pastFunctions[args];
      } else {
        var result = func.apply(this, arguments);
        pastFunctions[args] = result;
        return result;
      }
    }  
  };
  ...
  _.shuffle = function(array) {
    ...
    for (var i = 0; i < length; i++) { 
      var pick = getRandomNum(0, copy.length);  
      var selection = copy.splice(pick, 1);
      shuffled.push(Number(selection));
    }
    return shuffled;
  };
